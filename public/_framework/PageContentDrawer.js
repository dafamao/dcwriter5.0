...
export class PageContentDrawer {
    ...
    constructor(vCanvasElement, vCodes) {
        ...
        var DrawLines = function (pen, xyArray) {
            ...
            // 进行坐标修正
            var lenFix = xyArray.length - 2;
            var arrayFix = xyArray.slice();
            //for (var iCount = 0; iCount < lenFix; iCount += 2) {
            //    if (xyArray[iCount] == xyArray[iCount + 2]) {
            //        // 竖线
            //        arrayFix[iCount] = xyArray[iCount] + 0.5;
            //        arrayFix[iCount + 2] = xyArray[iCount + 2] + 0.5;
            //    }
            //    else if (xyArray[iCount + 1] == xyArray[iCount + 3]) {
            //        // 横线
            //        arrayFix[iCount + 1] = xyArray[iCount + 1] + 0.5;
            //        arrayFix[iCount + 3] = xyArray[iCount + 3] + 0.5;
            //    }
            //}
            var oldPen = _InnerSelectPen.call(this, pen);
            this.ctx.beginPath();
