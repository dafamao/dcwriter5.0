...
#dcPanelBody.dc_imgEdit .dc_Box.dc_imgEdit_Content .dc_allShow {
    padding-left: 4px;
    display: flex;
    align-items: center;
...
#dcPanelBody.dc_imgEdit .dc_Box.dc_imgEdit_Content .dc_allShow .dc_allShow_button{
    background: #fff;
    border: 1px solid #dcdfe6;
    color: #606266;
    border-radius: 50%;
...
#dcPanelBody.dc_imgEdit .dc_allShow_button,
